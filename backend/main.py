...
from routers import auth, emails, calendar, action_items, settings, reminders, errors, event_groups, ps_pdf, my_day
...
app.add_middleware(
    ...
    allow_origins=[
        ...
        "http://localhost:5176",
        "http://localhost:5177",
        "http://davidmac.local:5173",
        "http://davidmac.local:5174",
        "http://davidmac.local:5175",
        "http://davidmac.local:5176",
        "http://davidmac.local:5177",
    ],
...
app.include_router(my_day.router, prefix="/api/my-day", tags=["my-day"])
